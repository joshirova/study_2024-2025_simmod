...
![Суперблок, моделирующий поступление заявок](image/2.jpeg){#fig:002 width=70%}
...
![Суперблок, моделирующий обработку заявок](image/3.jpeg){#fig:003 width=70%}
...
![Модель $M|M|1|\infty$ в xcos](image/4.jpeg){#fig:004 width=70%}
...
![Динамика размера очереди](image/5.jpeg){#fig:005 width=70%}

![Поступление и обработка заявок](image/6.jpeg){#fig:006 width=70%}
