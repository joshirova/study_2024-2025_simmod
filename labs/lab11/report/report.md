...
![Задание деклараций системы](image/4.jpeg){#fig:004 width=70%}
...
![График изменения задержки в очереди](image/11.jpeg){#fig:011 width=70%}
...
![Содержимое Queue_Delay_Real.log](image/13.jpeg){#fig:013 width=70%}
...
![Содержимое Long_Delay_Time.log](image/16.jpeg){#fig:016 width=70%}
...
![Периоды времени, когда значения задержки в очереди превышали заданное значение](image/17.jpeg){#fig:017 width=70%}
